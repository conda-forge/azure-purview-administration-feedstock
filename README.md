About azure-purview-administration-feedstock
============================================
...
Installing `azure-purview-administration` from the `conda-forge/label/azure-purview-administration_rc` channel can be achieved by adding `conda-forge/label/azure-purview-administration_rc` to your channels with:

```
conda config --add channels conda-forge/label/azure-purview-administration_rc
conda config --set channel_priority strict
```

Once the `conda-forge/label/azure-purview-administration_rc` channel has been enabled, `azure-purview-administration` can be installed with `conda`:
...
```
conda search azure-purview-administration --channel conda-forge/label/azure-purview-administration_rc
```

or with `mamba`:

```
mamba search azure-purview-administration --channel conda-forge/label/azure-purview-administration_rc
```
...
mamba repoquery search azure-purview-administration --channel conda-forge/label/azure-purview-administration_rc

# List packages depending on `azure-purview-administration`:
mamba repoquery whoneeds azure-purview-administration --channel conda-forge/label/azure-purview-administration_rc

# List dependencies of `azure-purview-administration`:
mamba repoquery depends azure-purview-administration --channel conda-forge/label/azure-purview-administration_rc
```
